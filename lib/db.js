...
function buildSearchQuery(q, types, where = ['simpleName', 'ownerPathNameSearchable', 'tagsSearchable'], includeDeleted = true, rawFilters = [], rawFiltersJoiner = "AND", strict = true) {
